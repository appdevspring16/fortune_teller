...
#mp: camel case is important here
#mp: '<' inherits all of the rails code in application_controller so you dont have to re-enter it
  ...
  def ram
    ...
    render("ram.html.erb")
    #mp: view folder name must match the controller folder name
